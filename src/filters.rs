...
///
/// Returns the indices of positions whose normalized entropy exceeds
/// `mean + std_devs * std_dev`. The standard deviation is computed with the
/// population estimator (dividing by N, not N-1); this is a heuristic
/// outlier flag, not an inferential statistic.
#[must_use]
